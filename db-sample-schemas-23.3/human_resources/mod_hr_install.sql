...
rem
rem DESCRIPTION
rem   HR (Human Resources) is a sample schema resembling a generic HR schema.
rem
rem SCHEMA VERSION
rem   21
rem
...
rem  This script calls hr_code.sql, hr_cre.sql, hr_popul.sql
rem 
...
PROMPT Verifying HR installation...

SELECT 'count(1)' as "Verification", count(1) as "Count" FROM employees;
