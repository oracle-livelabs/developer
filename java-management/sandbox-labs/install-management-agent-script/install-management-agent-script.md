...
4. Scroll down the Fleet details page. Under **Resources** menu, select **Managed instances**. If installation of the management agent is successful, the Managed Instance will be indicated on the Fleet Main Page after **10 minutes**.
