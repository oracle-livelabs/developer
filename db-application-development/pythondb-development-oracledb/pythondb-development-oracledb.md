...
* Python-oracledb is simple and small to install — under 15 MB (including Python package dependencies) 
...
Use Python 3.7 to 3.10. Install [Python3](https://www.python.org/downloads/macos/).   

### Windows 

Use Python 3.7 to 3.10. Install [Python3](https://www.python.org/downloads/windows/).  

### Oracle Linux 

Use Python 3.6 to 3.10. Install [Python3](https://yum.oracle.com/oracle-linux-python.html). Python for Oracle Linux 
 
1. To install Python 3 from the Oracle Linux 8 latest repository
...
* **ewallet.pem** - Enables SSL/TLS connections in Thin mode. Keep this file secure
      ...
      View **tnsnames.ora** for connection details and copy the name of the connection string in the python script
      ...
      connection = oracledb.connect(user=username, password=user_pwd,
                                    dsn=dsn_name,
      ...
      Substitute <db\_user\> , <password\>, <path\_to\_config\_folder\_mywalletfiles\>  <dns\_name\> based on your configurations in Lab 1 
