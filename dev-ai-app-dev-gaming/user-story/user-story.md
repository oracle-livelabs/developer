...
In conclusion our Tournament Authorization App was able to leverage Oracle AI Database technologies such as **AI Vector Search, Property Graph and JSON Duality Views** to:

✅ Automate profile evaluations

✅ Provide AI-driven tournament recommendations by using an RAG model powered by a Oracle AI Database's AI Vector Search and OCI Generative AI service
...
* **Contributors** - Hanna Rakhsha, Ley Sylvester, Uma Kumar, Faaris Chaudhry
