...
This lab will discuss:

- Oracle REST Data Services (ORDS)
- OpenAPI documentation
- Swagger editor usage

### Objectives

In this lab, you will:
- Inspect the provided Oracle REST APIs
...
1. Locate the Paths
    ...
    - `GET` <i>and</i> `POST` `/locations/map/data`
    ...
    While these are all considered Paths, ORDS would also consider some of these as <i>Resource Templates</i>. All are unique, with the exception of the `\locations/map/data` and `/purchases/history` Resource Templates. These Resource Templates have a Resource <i>Handler</i> for `GET` <i>and</i> `POST` Operations.
...
2. Explore the Paths
    ...
    Here we'll review selected Paths (recall there are <i>four</i> Resource Templates) and discuss their importance to the Flask application.
      ...
      3. `POST` `/purchases/history`
        ...
        4. Congratulations. You should now have a thorough understanding of how our Oracle REST APIs are structured. 
