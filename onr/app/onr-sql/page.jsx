...
import deletes from "./details/delete.js"
...
const Data = () => {
    ...
    function refresh() {
      window.location.href = "onr-sql"
    }

    const doPOST = async () => {
      const resp = await fetch("database/onr-sql", { method: 'POST'} );
      refresh()
      setData(data);
    }

    const doPUT = async () => {
      const resp = await fetch("database/onr-sql", { method: 'PUT'} );
      refresh()
      setData(data);
    }
    ...
    const fetchData = async () => {
      const res = await fetch("database/onr-sql", { method: 'GET'} );
    ...
    <div className="overflow-x-auto">
      ...
      <Button variant="secondary" onClick={doPUT}>PUT - Update Smithy to smith using PUT code below</Button> &nbsp;&nbsp;&nbsp;
