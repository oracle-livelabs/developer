  const ddl = `
  drop table if exists emp;                -- New in DB23c
  drop table if exists dept;               -- New in DB23c
  
  create table if not exists dept          -- New in DB23c
    (DEPTNO NUMBER(2),
    CONSTRAINT dept_pkey PRIMARY KEY (deptno),
    DNAME VARCHAR2(14),
    LOC VARCHAR2(13) );
  create table if not exists emp           -- New in DB23c
