...
3. Log in to [freesql.com](https://www.freesql.com) and click the <button style="color: white; background-color: DarkSlateGray;>Connect with [rotating language option]<button> button.
