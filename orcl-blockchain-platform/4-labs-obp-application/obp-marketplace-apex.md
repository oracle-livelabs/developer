...
5. Click 'Refresh Theme' as shown.

  ![Refresh Theme](images/4-apex-4-5.png)

6. Next, scroll towards the bottom of your 'App Builder' homepage and under **Data Sources**, select 'REST Data Sources.'

  ![REST Data Sources](images/4-apex-4-6.png)

7. Click 'GetDealerByRange' to view information regarding this data source.

  ![GetDealerByRange](images/4-apex-4-7.png)

8. Click the pencil icon **Remote Server**. 

  ![Edit Remote Server](images/4-apex-4-8.png)

9. Make the following updates:
...
11. Set **URL Path Prefix** to v0/marketplace/chaincode/queries and click 'Apply Changes.'

  ![Edit URL Path Prefix and Apply Changes](images/4-apex-4-11.png)

12. Now, repeat steps 7-11 for the following REST Sources:
    - 'GetInvoiceByRange'
    - 'AccountBalance'
    - 'GetPOByRange'

  ![Repeat APEX Data Source Steps](images/4-apex-4-12.png)


## Task 5: Setup APEX Web Credentials

1. On the 'Shared Components' page, click on 'Web Credentials.'
...
The Marketplace shows the cars for sale by all the other dealers.

3. Now login as the other dealer, Dealer2.

4. Proceed to payment by clicking a car in the Marketplace. This car will disappear from the Marketplace when sold.
