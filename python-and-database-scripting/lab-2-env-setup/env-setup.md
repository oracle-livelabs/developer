...
python-oracledb 1.1 is available. It introduces a default **Thin** mode for direct connection to Oracle Database and Oracle client libraries are optional.
...
*Note: Cloud Shell has Python 3.8.13 preinstalled.*
