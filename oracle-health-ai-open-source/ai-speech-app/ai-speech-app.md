...
7. Display APEX Collection to view Transcription reponse
    ...
    > **Congratulations**, you have completed **Creating APEX Application for Speech Transcription** Labs. The subsequent labs are optional, however, please proceed to the next lab to learn more about **OCI Speech with Oracle Gen AI Integration**. 
