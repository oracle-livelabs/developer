...
In this lab, you’ll step into the shoes of a **Return Authorization Specialist** using an AI powered returns app built on Oracle AI Database. See how Generative AI, Vector Search, and Graph Analytics reduce review times by automating photo analysis, order verification, and fraud checks - all inside one converged database, with zero data shuffling.
...
2. Select **Retail** as Industry and **Return Authorization Specialist** as role. Enter in a username and click **Login**.
...
Lastly, lets explore how the system uses JSON Duality Views to handle profile updates. In this task, you will edit a customer’s details. In this example, the customer was asked to submit updated proof of carrier tracking.
...
✅ Provide AI-driven return recommendations by using an RAG model powered by a Oracle AI Database's AI Vector Search and OCI Generative AI service
