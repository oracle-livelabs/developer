...
2. Navigate to `db_setup_RET_script_2.sql` under the `dbinit` folder. Here is where you can see all the tables that will be created for the healthcare industry. 

    ![ENG-Table](./images/ret-table.png " ")
