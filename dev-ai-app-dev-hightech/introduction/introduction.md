...
You will:
  ...
  * Automate real-world high tech workflows, like interconnection approvals, by **embedding and querying unstructured data** in real time.

By the end of this workshop, you’ll understand how Oracle Database 23ai helps high tech organizations:
...
Check out the demo to see how Generative AI and Vector Search in the database, can operate against multiple types of data—empowering you to build real applications and make faster, smarter decisions. The best part? **No setup required**—just start with Lab 1 and follow the guide. You can explore guided use cases or experiment on your own using the demo application:
  ...
  * ✅ Login as a technical support engineer

  * ✅ Review support tickets that have been recommended by the system to be approved or denied

  * ✅ Upload information about a support ticket

#### ➡️ **Start coding! (Labs 2-3)**

Lab 2 describes how to get access to our browser-based development environment. Make sure to check it out before continuing to Lab 3, where you will get hands-on and start interacting with Python with Oracle Database 23ai:
...
You can also experiment with the code in your own environment. The workshop environment is flexible and allows you try out different things: Start building your own version of the support ticket application!

  * ✅ Vectorize support ticket data from one table into another
...
* Learn how Oracle Database 23ai capabilities can be used to automate and enhance the support ticket remediation process
