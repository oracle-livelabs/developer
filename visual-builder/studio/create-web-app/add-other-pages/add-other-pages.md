...
3.  Click **Edit Department**.
    ...
    ![](images/departments-edit.png "This image shows the Departments page in Preview, with a table row selected and with the Edit Department button selected.")
...
3.  Select a row. All the buttons are now active.
    ...
    ![](images/employees-edit.png "This image shows the Employees page in Preview, with a table row selected and the Edit Employee button selected. The bar chart on the right also shows.")
