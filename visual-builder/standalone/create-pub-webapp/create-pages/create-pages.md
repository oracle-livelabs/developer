...
3. Now that you're in the Page Designer, let's give this page a title. Click **main** on the page canvas—notice how the title text uses the Bind Text component.
    ![This image shows the Page Designer tab for the main-start page, with the 'main' text featured in the Bind Text component selected on the canvas.](images/vbcscp_dd_s3.png "")
...
6. Select the table if necessary, then click **Add Data** in the Properties pane's Quick Start tab to open the Add Data Quick Start.
    ...
    ![This image shows the Quick Start menu for a new Table. The Add Data quick start is the only option available for selection.](images/vbcscp_dd_s6.png "")
...
9. Expand the **locationObject** and **items** nodes (**item\[i\]** is expanded automatically) and select **location**. Because we created a reference from the Department business object to the Location business object, the location field is now available to us through the locationObject accessor, which lets us traverse relationships between the two objects. Click **Next**.
    ...
    ![This image shows part of the Bind Data page of the Add Data quick start after the location node has been expanded. The location check box is selected. In the Columns list, location appears at the bottom of the list.](images/vbcscp_dd_s9.png "")
...
7. Enter `IT` in the **Department** field, and select **Floor 4** from the **Location** drop-down list.
    ...
    ![This image shows the use of the Create Department page when you run the application. IT has been entered in the Department field, and Floor 4 has been selected from the Location list.](images/vbcscp_cpd_s7.png "")
    ...
    ![This image shows the web application's main flow, with the main-start page pointing to the main-create-department page.](images/vbcscp_cpd_s7_result.png "")
...
8. Double-click the **main-start** tile to open the page (you can also click the **main-start** tab just below the header or click the page in the Web Apps pane), then click **Reload Design Preview** ![Reload design preview icon](images/vbcscp_reload_icon.png) to see the department you created.
    ...
    ![This image shows the Departments page with the Create Department button and the table. The Reload Design Preview icon is selected.](images/vbcscp_cpd_s8.png "")
...
9. On the Bind Data step of the Add Data Quick Start, select the **picture** and **name** check boxes under **item\[i\]**.
    ...
    ![This image shows part of the Bind Data page of the Add Data quick start. The name and picture check boxes are selected.](images/vbcscp_cpe_s8.png "")

10. Expand the **departmentObject** and **items** nodes (**item\[i\]** is expanded automatically) and select **department**.

    ![This image shows part of the Bind Data page of the Add Data quick start after the departmentObject node has been expanded. The department check box is selected. In the Columns list, department appears at the bottom.](images/vbcscp_cpe_s9.png "")
...
7. Click **Live** to make the form active. Enter or select the following (you can use other data if you wish):
    ...
    ![This image shows the page flow for the application's main flow. The main-employees page points to the main-create-employee page, and  the main-start page points to the main-create-department page.](images/vbcscp_cpc_s7_result.png "")
...
9. Click **Code** (next to **Design** in the Page Designer toolbar) to view the HTML code for the main-employees page. You can see the code for the title, the table, and the chart within `div` elements. The components and classes all begin with `oj-`, indicating that they are Oracle JavaScript Extension Toolkit (JET) components.
    ...
    ![This image shows the HTML code for the main-employees page.](images/vbcscp_cpc_s9.png "")
...
1. In the Web Apps pane of the Navigator, right-click the **main-start** page and select **Rename**.
    ...
    ![This image shows the hrwebapp and main nodes expanded in the Navigator. The right-click menu for the main-start page is open, and the Rename menu item is selected.](images/vbcscp_cpn_s1.png "")
...
3. Click the **main** node. The page flow Diagram shows the now renamed page. Note how the main-departments page is still badged ![Default and Flow Entry badge](images/default-badge.png), indicating it as the page where your application starts when you run it.
    ...
    ![This image shows the page flow of the main flow after main-start has been renamed. The main-departments page still points to the main-create-department page, and the main-employees page points to the main-create-employee page.](images/vbcscp_cpn_s2.png "")

4. To find out why, click **Source** ![Source icon](images/vbcscp_sourceview_icon.png) in the Navigator and expand the **webApps**, **hrwebapp**, **flows**, and **main** nodes, then click **main-flow.json**.

    ![This image shows the Source view pane, with the webApps, hrwebapp, flows, and main nodes expanded. The main-flow.json file has been selected and is open. In it, the 'defaultPage' property is set to the value 'main-departments'.](images/vbcscp_cpn_s4.png "")
